  ...
  return (
    ...
    >
      <NavigationSurfaceHeader
        ...
        controlsId={navId}
      />
      <nav id={navId} className="flex-1 overflow-y-auto px-2 py-4" aria-label="Workspace sections">
                  ...
                  <>
                    <item.icon
                      className={clsx(
                        ...
                        isActive ? "text-brand-600" : "text-slate-500 group-hover:text-brand-600",
                      )}
                      aria-hidden
                    />
                    <span
