...
export function WorkspaceSectionSidebar({
  ...
  return (
    ...
    >
      ...
      <div id={navId} className="flex-1 overflow-y-auto px-2 py-4">
...
function Badge({ collapsed, children }: { readonly collapsed: boolean; readonly children: string }) {
  return (
    <span
      className={clsx(
        "inline-flex items-center rounded-full bg-brand-50 px-2 py-0.5 text-xs font-semibold text-brand-700 transition-opacity duration-200",
