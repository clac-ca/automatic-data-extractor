...
import { WorkspacePageHeaderProvider } from "../workspaces/WorkspacePageHeaderContext";
...
function WorkspaceLayoutInner({ workspace }: WorkspaceLayoutInnerProps) {
  ...
  useEffect(() => {
    ...
    window.localStorage.setItem(navStorageKey, String(isNavCollapsed));
  }, [isNavCollapsed, navStorageKey]);
      ...
      <div className="relative flex flex-1 overflow-hidden" key={`section-${sectionKey}`}>
        ...
        <main className="relative flex-1 overflow-y-auto">
          <div className="mx-auto flex w-full max-w-7xl flex-col px-4 py-6">
            <WorkspacePageHeaderProvider defaultTitle="Workspace">
