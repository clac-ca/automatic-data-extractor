---
title: Data Grid
description: Spreadsheet-like grid with editable cells, selection, and keyboard-first workflows.
component: true
---
...
<Steps>
  <Step>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
  </Step>
  ...
  <Step>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid-select-column"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid-select-column"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid-sort-menu"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid-sort-menu"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid-filter-menu"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid-filter-menu"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid-row-height-menu"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid-row-height-menu"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid-view-menu"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid-view-menu"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid-keyboard-shortcuts"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid-keyboard-shortcuts"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/data-grid-skeleton"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/data-grid-skeleton"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx shadcn@latest add "@diceui/use-data-grid-undo-redo"
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x shadcn@latest add "@diceui/use-data-grid-undo-redo"
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
  </Step>
  ...
  <Step>
    ...
    The shadcn CLI does not handle custom component paths properly ([see issue](https://github.com/shadcn-ui/ui/issues/8308)). You will need to update these imports manually:
...
function DataGridImpl() {
  ...
  return <DataGrid table={table} {...dataGridProps} />;
}
```
...
<AutoTypeTable path="./types/docs/data-grid.ts" name="UseDataGridUndoRedoProps" />

Returns:

<AutoTypeTable path="./types/docs/data-grid.ts" name="UseDataGridUndoRedoReturn" />
...
<AutoTypeTable path="./types/docs/data-grid.ts" name="GetDataGridSelectColumnProps" />
...
<AutoTypeTable path="./types/docs/data-grid.ts" name="DataGridFilterMenuProps" />
...
<AutoTypeTable path="./types/docs/data-grid.ts" name="DataGridPasteDialogProps" />
...
<AutoTypeTable path="./types/docs/data-grid.ts" name="DataGridSkeletonProps" />

#### DataGridSkeletonToolbar

<AutoTypeTable path="./types/docs/data-grid.ts" name="DataGridSkeletonToolbarProps" />

#### DataGridSkeletonGrid

<AutoTypeTable path="./types/docs/data-grid.ts" name="DataGridSkeletonGridProps" />
...
<KeyboardShortcutsTable
  ...
  {
    keys: ["Ctrl + Shift + Up", "Cmd + Shift + Up"],
    description: "Select to top of table",
  },
  {
    keys: ["Ctrl + Shift + Down", "Cmd + Shift + Down"],
    description: "Select to bottom of table",
  },
  {
    keys: ["Ctrl + Shift + Left", "Cmd + Shift + Left"],
    description: "Select to first column",
  },
  {
    keys: ["Ctrl + Shift + Right", "Cmd + Shift + Right"],
...
<KeyboardShortcutsTable
  ...
  {
    keys: ["Ctrl + Backspace", "Cmd + Backspace"],
...
<KeyboardShortcutsTable
  ...
  {
    keys: ["Enter"],
    description: "Next search match (when search is open)",
  },
  {
    keys: ["Shift + Enter"],
    description: "Previous search match (when search is open)",
  },
  {
    keys: ["Escape"],
    description: "Close search (when search is open)",
  },
  {
