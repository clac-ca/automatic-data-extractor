...
import { parseCellKey } from "@components/tablecn/lib/data-grid";
import type { ContextMenuState, UpdateCell } from "@components/tablecn/types/data-grid";
...
function ContextMenuImpl<TData>({
  ...
  const onDelete = React.useCallback(async () => {
    ...
    notifyToast({
      title: `${rowCount} row${rowCount !== 1 ? "s" : ""} deleted`,
      intent: "success",
    });
  }, [propsRef]);
