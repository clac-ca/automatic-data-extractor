...
import type { UploadManagerQueueItem } from "@shared/documents/uploadManager";
import { Alert } from "@ui/Alert";
import { Button } from "@ui/Button";
import { CloseIcon, TrashIcon, UploadIcon } from "@ui/Icons";
...
function resolveActiveSheetName(workbook: {
  SheetNames?: string[];
  Workbook?: { Views?: Array<{ activeTab?: number }> };
}, names: string[]) {
  const activeTab = workbook.Workbook?.Views?.[0]?.activeTab;
