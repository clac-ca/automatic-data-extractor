            ...
            {renderableLines.map((line) => (
              ...
              >
                <div className="flex min-w-0 flex-1 items-baseline gap-2">
                  ...
                  <span className="shrink-0 w-14 text-right font-mono text-[11px] leading-snug text-[#606674]">
                    {originLabel(line.origin)}
                  </span>
                  <span className={clsx("shrink-0 w-16 text-right font-mono text-[11px] leading-snug", prefixTone(line.level))}>
