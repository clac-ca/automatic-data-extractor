            ...
            <table className="min-w-full divide-y divide-slate-200">
              ...
              <tbody className="divide-y divide-slate-200 bg-white">
                {filteredRoles.map((role) => (
                  <tr key={role.id} className="text-sm text-slate-700">
                    ...
                    <td className="px-4 py-3 text-slate-600">{role.slug}</td>
                    <td className="px-4 py-3 text-slate-600">{role.permissions.length} permission{role.permissions.length === 1 ? "" : "s"}</td>
