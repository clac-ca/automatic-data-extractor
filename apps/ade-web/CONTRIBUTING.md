...
- **Respect the layers.** Never import from an "upwards" layer (`api/`, `hooks/`, `utils/`, `components/` must not import `pages/` or the app shell). ESLint will fail fast if you try.
