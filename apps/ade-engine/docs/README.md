...
12. [`12-run-summary-and-reporting.md`](./12-run-summary-and-reporting.md)  
    Run summary schema (`ade.run_summary/v1`), how it’s computed from artifacts
    and events, and how to persist/report it.
