...
from apps.api.app.features.auth.dependencies import get_current_identity
...
from apps.api.app.shared.core.security import forbidden_response, resolve_workspace_scope
