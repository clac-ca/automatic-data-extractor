...
def detect_header(*, row_index: int, manifest=None, logger=None, event_emitter=None, **_: object) -> dict[str, object]:
    """Score the first row as the header and others as data."""
    return {"scores": {"header": 1.0 if row_index == 1 else 0.0, "data": 0.0}}


def detect_data(*, row_index: int, manifest=None, logger=None, event_emitter=None, **_: object) -> dict[str, object]:
