...
from ade.features.roles.models import Principal, Role, RoleAssignment, RolePermission
from ade.features.roles.registry import PERMISSION_REGISTRY, SYSTEM_ROLES
...
if TYPE_CHECKING:
    from ade.features.roles.schemas import RoleCreate, RoleUpdate
