...
from ade.features.auth.dependencies import get_current_identity
from ade.features.auth.service import AuthenticatedIdentity
from ade.features.roles.authorization import authorize
from ade.features.users.models import User
from ade.platform.security import forbidden_response, resolve_workspace_scope
