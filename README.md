...
Open <http://localhost:8000/docs> to explore the autogenerated OpenAPI documentation. Docs are enabled automatically for `local`
and `staging` environments and can be toggled explicitly by setting `ADE_ENABLE_DOCS=true|false` in your environment.
