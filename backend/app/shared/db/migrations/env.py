...
from backend.app.shared.db import metadata
from backend.app.shared.db.engine import render_sync_url
...
def _import_feature_models() -> None:
    ...
    import backend.app.features.configurations.models  # noqa: F401
    ...
    import backend.app.features.workspaces.models  # noqa: F401
