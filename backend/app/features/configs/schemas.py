...
class ValidationIssueCode(StrEnum):
    """Machine-readable codes describing validation issues."""

    STRUCTURE_UNKNOWN = "STRUCT001"
    MANIFEST_JSON = "MANIFEST001"
    MANIFEST_SCHEMA = "MANIFEST002"
    HOOK_MISSING = "HOOK001"
    HOOK_SIGNATURE = "HOOK002"
    COLUMN_MISSING = "COLUMN001"
    COLUMN_DETECT = "COLUMN002"
    COLUMN_TRANSFORM = "COLUMN003"
