...
from backend.app.features.roles.models import Principal, Role, RoleAssignment, RolePermission
from backend.app.features.roles.service import assign_global_role
from backend.app.features.workspaces.models import WorkspaceMembership
...
async def test_update_workspace_role_blocks_governor_loss(
    ...
    downgrbackend_app_response = await async_client.put(
    ...
    assert downgrbackend_app_response.status_code == 409
