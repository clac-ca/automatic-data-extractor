...
- Background work is handled by the in-process task queue defined in [`ade/workers/task_queue.py`](../../ade/workers/task_queue.py).
- Structured logging and correlation IDs are configured through [`ade/platform/logging.py`](../../ade/platform/logging.py) and middleware in [`ade/platform/middleware.py`](../../ade/platform/middleware.py).
