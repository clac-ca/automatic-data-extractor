...
Below is an **implementation sketch** (simplified but faithful). You can drop this into `apps/api/app/kernel/build/prepare.py` and wire it to your “activate config” path.

```python
# apps/api/app/kernel/build/prepare.py
...
```python
# apps/api/app/features/jobs/launcher.py (sketch)
