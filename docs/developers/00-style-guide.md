...
- If a term appears in the glossary, link its first mention on a page to `docs/developers/02-glossary.md`. Maintain consistent terminology—do not switch between synonyms for the same concept.
...
We maintain detailed snippet guidance in [`docs/developers/00-templates/snippet-conventions.md`](./00-templates/snippet-conventions.md). Follow these core principles:
...
Treat documentation reviews with the same care as code reviews. Read drafts aloud to spot awkward phrasing, confirm that instructions follow the page template in `docs/developers/00-templates/page-template.md`, and double-check links, examples, and placeholders. Consistent application of this style guide keeps the docs welcoming, precise, and dependable.
