# Work Packages — Config Authoring, Builds, and Runs
...
* [02-build-venv.md](../02-build-venv.md) — how builds create isolated virtual environments and how runs consume them.
...
| [WP6](./wp6-runs-integration.md) | Runs Integration | Run runs in ensured builds and store `build_id` on run rows. |
